                ...
                <div class="panel-body" id="panel-body">
                    ...
                    <div class="row">
                        <div class="message {{ ($chat->user_id!=Auth::user()->id)?'not_owner':'owner'}}">
                            <img src="{{asset('storage/images/pp.jpg')}}" alt="Avatar" class="avatar">
...
<script>
    ...
    socket.on('message', function (data) {
        ...
        if(data['data'].users.id == user){
            $('#panel-body').append(
                    '<div class="row">'+
                    '<div class="message owner">'+'<img src="{{asset('storage/images/pp.jpg')}}" alt="Avatar" class="avatar">'+data['data'].users.name+'<br/>'
            ...
            $('#panel-body').append(
                    '<div class="row">'+
                    '<div class="message not_owner">'+'<img src="{{asset('storage/images/pp.jpg')}}" alt="Avatar" class="avatar">'+data['data'].users.name+'<br/>'
                    +data['data'].message+'<br/>'+data['time']+
                    '</div>'+
                    '</div>');
